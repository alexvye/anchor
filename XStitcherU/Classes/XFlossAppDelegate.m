...
-(void)loadData {
     ...
     // Load the threads
     //
         NSString *filePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"anchor" ofType:@"csv"];
    ...
    //
         filePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"anchor-cat" ofType:@"csv"];
